...
foreach(f ${meta})
  ...
  if(BUILD_TESTING)
    if(EXISTS ${${vtk-module}_SOURCE_DIR}/Testing/Cxx)
      vtk_add_test_module(Cxx)
    endif()
    if(EXISTS ${${vtk-module}_SOURCE_DIR}/Testing/Tcl)
      vtk_add_test_module(Tcl)
    endif()
    if(EXISTS ${${vtk-module}_SOURCE_DIR}/Testing/Java)
      vtk_add_test_module(Java)
    endif()  
    if(EXISTS ${${vtk-module}_SOURCE_DIR}/Testing/Python)
      vtk_add_test_module(Python)
    endif()
  endif()
endforeach()
