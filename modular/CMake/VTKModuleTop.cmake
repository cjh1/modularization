...
foreach(f ${meta})
  ...
  if(BUILD_TESTING AND EXISTS ${${vtk-module}_SOURCE_DIR}/test)
    list(APPEND VTK_MODULES_ALL ${vtk-module-test})
    set(${vtk-module-test}_SOURCE_DIR ${${vtk-module}_SOURCE_DIR}/test)
    set(${vtk-module-test}_BINARY_DIR ${${vtk-module}_BINARY_DIR}/test)
